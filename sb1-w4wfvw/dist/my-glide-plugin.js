...
(function(ut, B) {
  (function(l, lt) {
    ...
    var me = window.requestAnimationFrame || _e("RequestAnimationFrame") || ni, oi = window.cancelAnimationFrame || _e("CancelAnimationFrame") || _e("CancelRequestAnimationFrame") || function(t) {
    ...
    nt.extend = function(t) {
      ...
      return t.statics && T(e, t.statics), t.includes && (wn(t.includes), T.apply(null, [n].concat(t.includes))), T(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? wt(i.options) : {}, T(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
    ...
    function _(t, e, i) {
      return t instanceof m ? t : Y(t) ? new m(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new m(t.x, t.y) : new m(t, e, i);
    }
    function z(t, e) {
      if (t)
    ...
    W.prototype = {
      ...
      contains: function(t) {
        ...
        var e = this._southWest, i = this._northEast, n, o;
        return t instanceof W ? (n = t.getSouthWest(), o = t.getNorthEast()) : n = o = t, n.lat >= e.lat && o.lat <= i.lat && n.lng >= e.lng && o.lng <= i.lng;
      },
    ...
    function y(t, e, i) {
      return t instanceof b ? t : Y(t) && typeof t[0] != "object" ? t.length === 3 ? new b(t[0], t[1], t[2]) : t.length === 2 ? new b(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new b(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new b(t, e, i);
    }
    var ot = {
      ...
      wrapLatLng: function(t) {
        var e = this.wrapLng ? kt(t.lng, this.wrapLng, !0) : t.lng, i = this.wrapLat ? kt(t.lat, this.wrapLat, !0) : t.lat, n = t.alt;
        return new b(i, e, n);
      },
    ...
    var ye = document.documentElement.style, jt = "ActiveXObject" in window, Pn = jt && !document.addEventListener, ui = "msLaunchUri" in navigator && !("documentMode" in document), we = Q("webkit"), li = Q("android"), ci = Q("android 2") || Q("android 3"), Ln = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Tn = li && Q("Google") && Ln < 537 && !("AudioNode" in window), xe = !!window.opera, fi = !ui && Q("chrome"), di = Q("gecko") && !we && !xe && !jt, bn = !fi && Q("safari"), _i = Q("phantom"), mi = "OTransition" in ye, Mn = navigator.platform.indexOf("Win") === 0, pi = jt && "transition" in ye, Pe = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !ci, gi = "MozPerspective" in ye, Cn = !window.L_DISABLE_3D && (pi || Pe || gi) && !mi && !_i, Ot = typeof orientation < "u" || Q("mobile"), Sn = Ot && we, zn = Ot && Pe, vi = !window.PointerEvent && window.MSPointerEvent, yi = !!(window.PointerEvent || vi), wi = "ontouchstart" in window || !!window.TouchEvent, kn = !window.L_NO_TOUCH && (wi || yi), En = Ot && xe, Zn = Ot && di, On = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, In = function() {
      var t = !1;
      try {
    ...
    }(), Le = !!(document.createElementNS && ai("svg").createSVGRect), Bn = !!Le && function() {
    ...
    var f = {
      ...
      mac: Rn,
      linux: Dn
    }, xi = f.msPointer ? "MSPointerDown" : "pointerdown", Pi = f.msPointer ? "MSPointerMove" : "pointermove", Li = f.msPointer ? "MSPointerUp" : "pointerup", Ti = f.msPointer ? "MSPointerCancel" : "pointercancel", Te = {
      touchstart: xi,
      touchmove: Pi,
      touchend: Li,
      touchcancel: Ti
    ...
    function Fn(t, e, i) {
      return e === "touchstart" && Gn(), bi[e] ? (i = bi[e].bind(this, i), t.addEventListener(Te[e], i, !1), i) : (console.warn("wrong event specified:", e), E);
    }
    function Hn(t, e, i) {
      if (!Te[e]) {
    ...
    function Vn(t, e) {
      e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && R(e), Kt(t, e);
    }
    function qn(t) {
      var e = {}, i, n;
      for (n in t)
    ...
    ), Si = It === "webkitTransition" || It === "OTransition" ? It + "End" : "transitionend";
    function zi(t) {
    ...
    function Z(t, e) {
      t.classList !== void 0 ? t.classList.remove(e) : Ce(t, fe((" " + Xt(t) + " ").replace(" " + e + " ", " ")));
    }
    function Ce(t, e) {
    ...
    if ("onselectstart" in document)
      ...
      Bt = function() {
        ...
        Rt && (document.documentElement.style[Rt] = Se, Se = void 0);
      };
    }
    function ze() {
    ...
    function Ae(t, e, i, n) {
      ...
      !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? s = Fn(t, e, s) : f.touch && e === "dblclick" ? s = Kn(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Ie[e] || e, s, f.passiveEvents ? { passive: !1 } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
    ...
    function Be(t, e, i, n, o) {
      ...
      if (!s)
        return this;
      !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? Hn(t, e, s) : f.touch && e === "dblclick" ? Yn(t, s) : "removeEventListener" in t ? t.removeEventListener(Ie[e] || e, s, !1) : t.detachEvent("on" + e, s), t[tt][o] = null;
    }
    function gt(t) {
      return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = !0 : t.cancelBubble = !0, this;
    }
    function Ne(t) {
      return Ae(t, "wheel", gt), this;
    }
    function Dt(t) {
    ...
    var Qn = {
      ...
      flyTo: function(t, e, i) {
        ...
        function v(A) {
          var ce = A ? -1 : 1, Wo = A ? h : a, Uo = h * h - a * a + ce * d * d * u * u, Go = 2 * Wo * d * u, Ye = Uo / Go, pn = Math.sqrt(Ye * Ye + 1) - Ye, Vo = pn < 1e-9 ? -18 : Math.log(pn);
          return Vo;
        }
        function D(A) {
        ...
        var U = v(0);
        function zt(A) {
          return a * (N(U) / N(U + c * A));
        }
        function Ro(A) {
          return a * (N(U) * K(U + c * A) - D(U)) / d;
        }
        function Do(A) {
          return 1 - Math.pow(1 - A, 1.5);
        }
        var Fo = Date.now(), _n = (v(1) - U) / c, Ho = i.duration ? 1e3 * i.duration : 1e3 * _n * 0.8;
        function mn() {
          var A = (Date.now() - Fo) / Ho, ce = Do(A) * _n;
          A <= 1 ? (this._flyToFrame = F(mn, this), this._move(
            this.unproject(n.add(o.subtract(n).multiplyBy(Ro(ce) / u)), r),
            this.getScaleZoom(a / zt(ce), r),
            { flyTo: !0 }
      ...
      remove: function() {
        ...
        this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), k(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (V(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
        var t;
      ...
      getBoundsZoom: function(t, e, i) {
        t = O(t), i = _(i || [0, 0]);
        var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), u = H(this.project(a, n), this.project(r, n)).getSize(), c = f.any3d ? this.options.zoomSnap : 1, d = h.x / u.x, v = h.y / u.y, D = e ? Math.max(d, v) : Math.min(d, v);
        return n = this.getScaleZoom(D, n), c && (n = Math.round(n / (c / 100)) * (c / 100), n = e ? Math.ceil(n / c) * c : Math.floor(n / c) * c), Math.max(o, Math.min(s, n));
      },
      // @method getSize(): Point
      ...
      _onResize: function() {
        V(this._resizeRequest), this._resizeRequest = F(
          function() {
      ...
      _tryAnimatedZoom: function(t, e, i) {
        ...
        return i.animate !== !0 && !this.getSize().contains(o) ? !1 : (F(function() {
    ...
    var Bi = X.extend({
      ...
      expand: function() {
        ...
        return t < this._section.clientHeight ? (g(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : Z(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
      },
      ...
      _initLayout: function() {
        ...
        e.setAttribute("aria-haspopup", !0), Dt(e), Ne(e);
      ...
      _createButton: function(t, e, i, n, o) {
        var s = P("a", i, n);
        return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Dt(s), p(s, "click", vt), p(s, "click", o, this), p(s, "click", this._refocusOnMap, this), s;
      },
      _updateDisabled: function() {
        var t = this._map, e = "leaflet-disabled";
        Z(this._zoomInButton, e), Z(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (g(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (g(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
      }
    });
    w.mergeOptions({
      zoomControl: !0
    ...
    var io = function(t) {
      ...
      return new Ni(t);
    }, oo = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', Fe = X.extend({
      // @section
      ...
      onAdd: function(t) {
        t.attributionControl = this, this._container = P("div", "leaflet-control-attribution"), Dt(this._container);
    ...
    X.Layers = Bi, X.Zoom = De, X.Scale = Ni, X.Attribution = Fe, Ft.layers = eo, Ft.zoom = io, Ft.scale = no, Ft.attribution = so;
    var et = nt.extend({
      initialize: function(t) {
        this._map = t;
      },
    ...
    var ro = { Events: G }, Ri = f.touch ? "touchstart mousedown" : "mousedown", ft = Et.extend({
      options: {
        // @section
      ...
      disable: function() {
        this._enabled && (ft._dragging === this && this.finishDrag(!0), M(this._dragStartTarget, Ri, this._onDown, this), this._enabled = !1, this._moved = !1);
      },
      _onDown: function(t) {
        if (this._enabled && (this._moved = !1, !Me(this._element, "leaflet-zoom-anim"))) {
          ...
          if (!(ft._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (ft._dragging = this, this._preventOutline && Ze(this._element), ze(), Bt(), !this._moving)) {
            this.fire("down");
      ...
      finishDrag: function(t) {
        Z(document.body, "leaflet-dragging"), this._lastTarget && (Z(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), M(document, "mousemove touchmove", this._onMove, this), M(document, "mouseup touchend touchcancel", this._onUp, this), ke(), Nt();
    ...
    function Di(t, e, i) {
      ...
      for (a = 0; a < 4; a++) {
        for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
          h = t[s], u = t[r], h._code & d ? u._code & d || (v = te(u, h, d, e, i), v._code = yt(v, e), n.push(v)) : (u._code & d && (v = te(u, h, d, e, i), v._code = yt(v, e), n.push(v)), n.push(h));
        t = n;
      }
      return t;
    }
    function Fi(t, e) {
      ...
      j(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var d = y([0, 0]), v = O(t), D = v.getNorthWest().distanceTo(v.getSouthWest()) * v.getNorthEast().distanceTo(v.getNorthWest());
      D < 1700 && (d = He(t));
      var N = t.length, K = [];
      for (i = 0; i < N; i++) {
        var U = y(t[i]);
        K.push(e.project(y([U.lat - d.lat, U.lng - d.lng])));
      }
      for (a = h = u = 0, i = 0, n = N - 1; i < N; n = i++)
        o = K[i], s = K[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, u += (o.y + s.y) * r, a += r * 3;
      a === 0 ? c = K[0] : c = [h / a, u / a];
      var zt = e.unproject(_(c));
      return y([zt.lat + d.lat, zt.lng + d.lng]);
    }
    function He(t) {
    ...
    function Vi(t) {
      return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), j(t);
    }
    function qi(t, e) {
      var i, n, o, s, r, a, h, u;
      if (!t || t.length === 0)
        throw new Error("latlngs not passed");
      j(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
      var c = y([0, 0]), d = O(t), v = d.getNorthWest().distanceTo(d.getSouthWest()) * d.getNorthEast().distanceTo(d.getNorthWest());
      v < 1700 && (c = He(t));
      var D = t.length, N = [];
      for (i = 0; i < D; i++) {
        var K = y(t[i]);
        N.push(e.project(y([K.lat - c.lat, K.lng - c.lng])));
      }
      for (i = 0, n = 0; i < D - 1; i++)
        n += N[i].distanceTo(N[i + 1]) / 2;
      if (n === 0)
        u = N[0];
      else
        for (i = 0, s = 0; i < D - 1; i++)
          if (r = N[i], a = N[i + 1], o = r.distanceTo(a), s += o, s > n) {
            h = (s - n) / o, u = [
              a.x - h * (a.x - r.x),
              a.y - h * (a.y - r.y)
            ];
      ...
      var U = e.unproject(_(u));
      return y([U.lat + c.lat, U.lng + c.lng]);
    }
    var fo = {
      __proto__: null,
      simplify: Hi,
    ...
    ot.Earth = ct, ot.EPSG3395 = mo, ot.EPSG3857 = ve, ot.EPSG900913 = xn, ot.EPSG4326 = ji, ot.Simple = po;
    var J = Et.extend({
    ...
    var Wt = bt.extend({
      ...
      _getIconUrl: function(t) {
        return typeof Wt.imagePath != "string" && (Wt.imagePath = this._detectIconPath()), (this.options.imagePath || Wt.imagePath) + bt.prototype._getIconUrl.call(this, t);
      },
      ...
      _detectIconPath: function() {
        var t = P("div", "leaflet-default-icon-path", document.body), e = At(t, "background-image") || At(t, "backgroundImage");
      ...
      _adjustPan: function(t) {
        var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = pt(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = H(
        ...
        if (!h.contains(s)) {
          ...
          i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), I(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = F(this._adjustPan.bind(this, t));
        }
      },
      ...
      _onPreDrag: function(t) {
        this._marker.options.autoPan && (V(this._panRequest), this._panRequest = F(this._adjustPan.bind(this, t)));
      },
      _onDrag: function(t) {
    ...
    var Ve = ie.extend({
      initialize: function(t, e, i) {
        if (typeof e == "number" && (e = T({}, i, { radius: e })), S(this, e), this._latlng = y(t), isNaN(this.options.radius))
    ...
    var rt = dt.extend({
      ...
      _defaultShape: function() {
        return j(this._latlngs) ? this._latlngs : this._latlngs[0];
      },
      // recursively convert latlngs input into actual LatLng instances; calculate bounds along the way
      _convertLatLngs: function(t) {
        for (var e = [], i = j(t), n = 0, o = t.length; n < o; n++)
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
          ...
          for (i = 0, o = 0, s = this._rings.length; i < s; i++)
            for (h = this._rings[i], n = 0, r = h.length; n < r - 1; n++)
              a = Gi(h[n], h[n + 1], t, n, !0), a && (e[o] = e[o] || [], e[o].push(a[0]), (a[1] !== h[n + 1] || n === r - 2) && (e[o].push(a[1]), o++));
        }
      },
    ...
    var Mt = rt.extend({
      ...
      _setLatLngs: function(t) {
        rt.prototype._setLatLngs.call(this, t), j(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function() {
        return j(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
      },
      _clipPoints: function() {
    ...
    function ne(t, e) {
      ...
      switch (i.type) {
        ...
        case "Polygon":
        case "MultiPolygon":
          return h = oe(n, i.type === "Polygon" ? 1 : 2, r), new Mt(h, e);
    ...
    function se(t, e, i, n) {
      for (var o = [], s = 0, r = t.length; s < r; s++)
        o.push(e ? se(t[s], j(t[s]) ? 0 : e - 1, i, n) : je(t[s], n));
      return !e && i && o.length > 0 && o.push(o[0].slice()), o;
    }
    function Ct(t, e) {
      return t.feature ? T({}, t.feature, { geometry: e }) : re(e);
    }
    function re(t) {
    ...
    ee.include(Ke), Ve.include(Ke), ie.include(Ke), rt.include({
      toGeoJSON: function(t) {
        var e = !j(this._latlngs), i = se(this._latlngs, e ? 1 : 0, !1, t);
        return Ct(this, {
      ...
      toGeoJSON: function(t) {
        var e = !j(this._latlngs), i = e && !j(this._latlngs[0]), n = se(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
        return e || (n = [n]), Ct(this, {
    ...
    var bo = Xi, ae = J.extend({
      ...
      _initImage: function() {
        ...
        if (g(e, "leaflet-image-layer"), this._zoomAnimated && g(e, "leaflet-zoom-animated"), this.options.className && g(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onload = C(this.fire, this, "load"), e.onerror = C(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
          this._url = e.src;
          return;
        }
      ...
      _initImage: function() {
        ...
        if (g(e, "leaflet-image-layer"), this._zoomAnimated && g(e, "leaflet-zoom-animated"), this.options.className && g(e, this.options.className), e.onselectstart = E, e.onmousemove = E, e.onloadeddata = C(this.fire, this, "load"), t) {
    ...
    var it = J.extend({
      ...
      initialize: function(t, e) {
        t && (t instanceof b || Y(t)) ? (this._latlng = y(t), S(this, e)) : (S(this, t), this._source = e), this.options.content && (this._content = this.options.content);
      },
      ...
      onRemove: function(t) {
        t._fadeAnimated ? (q(this._container, 0), this._removeTimeout = setTimeout(C(k, void 0, this._container), 200)) : k(this._container), this.options.interactive && (Z(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
      },
    ...
    var he = it.extend({
      ...
      onAdd: function(t) {
        it.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof dt || this._source.on("preclick", gt));
      },
      onRemove: function(t) {
        it.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof dt || this._source.off("preclick", gt));
      },
      getEvents: function() {
      ...
      _initLayout: function() {
        ...
        if (this._contentNode = P("div", t + "-content", i), Dt(e), Ne(this._contentNode), p(e, "contextmenu", gt), this._tipContainer = P("div", t + "-tip-container", e), this._tip = P("div", t + "-tip", this._tipContainer), this.options.closeButton) {
      ...
      _updateLayout: function() {
        ...
        o && n > o ? (e.height = o + "px", g(t, s)) : Z(t, s), this._containerWidth = this._container.offsetWidth;
      },
      _animateZoom: function(t) {
      ...
      _adjustPan: function() {
        if (this.options.autoPan) {
          ...
          var t = this._map, e = parseInt(At(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new m(this._containerLeft, -i - this._containerBottom);
    ...
    var ue = it.extend({
      ...
      _setPosition: function(t) {
        ...
        a === "top" ? (e = h / 2, i = u) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = u / 2) : a === "right" ? (e = 0, i = u / 2) : a === "left" ? (e = h, i = u / 2) : r.x < s.x ? (a = "right", e = 0, i = u / 2) : (a = "left", e = h + (c.x + d.x) * 2, i = u / 2), t = t.subtract(_(e, i, !0)).add(c).add(d), Z(o, "leaflet-tooltip-right"), Z(o, "leaflet-tooltip-left"), Z(o, "leaflet-tooltip-top"), Z(o, "leaflet-tooltip-bottom"), g(o, "leaflet-tooltip-" + a), I(o, t);
      },
      _updatePosition: function() {
    ...
    var Ut = J.extend({
      ...
      bringToBack: function() {
        return this._map && (Lt(this._container), this._setAutoZIndex(Math.min)), this;
      },
      // @method getContainer: HTMLElement
            ...
            for (var d = o.min.y; d <= o.max.y; d++)
              for (var v = o.min.x; v <= o.max.x; v++) {
                ...
                if (D.z = this._tileZoom, !!this._isValidTile(D)) {
                  var N = this._tiles[this._tileCoordsToKey(D)];
                  N ? N.current = !0 : r.push(D);
                }
              }
            if (r.sort(function(U, zt) {
              return U.distanceTo(s) - zt.distanceTo(s);
            }), r.length !== 0) {
      ...
      _tileCoordsToBounds: function(t) {
        var e = this._tileCoordsToNwSe(t), i = new W(e[0], e[1]);
      ...
      _initTile: function(t) {
        ...
        t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = E, t.onmousemove = E, f.ielt9 && this.options.opacity < 1 && q(t, this.options.opacity);
      },
      _addTile: function(t, e) {
        var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), C(this._tileReady, this, t));
        this._initTile(o), this.createTile.length < 2 && F(C(this._tileReady, this, t, null, o)), I(o, i), this._tiles[n] = {
          el: o,
          coords: t,
          current: !0
      ...
      _tileReady: function(t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (q(i.el, 0), V(this._fadeFrame), this._fadeFrame = F(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (g(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
          tile: i.el,
          coords: t
        })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), f.ielt9 || !this._map._fadeAnimated ? F(this._pruneTiles, this) : setTimeout(C(this._pruneTiles, this), 250)));
      },
      ...
      _wrapCoords: function(t) {
        var e = new m(
          this._wrapX ? kt(t.x, this._wrapX) : t.x,
          this._wrapY ? kt(t.y, this._wrapY) : t.y
        );
        return e.z = t.z, e;
      },
    ...
    var St = Ut.extend({
      ...
      getTileUrl: function(t) {
        ...
        return ei(this._url, T(e, this.options));
      },
      ...
      _removeTile: function(t) {
        var e = this._tiles[t];
        if (e)
          return e.el.setAttribute("src", qt), Ut.prototype._removeTile.call(this, t);
      },
      _tileReady: function(t, e, i) {
        if (!(!this._map || i && i.getAttribute("src") === qt))
          return Ut.prototype._tileReady.call(this, t, e, i);
      }
    });
    function tn(t, e) {
      return new St(t, e);
    ...
    var en = St.extend({
      ...
      getTileUrl: function(t) {
        var e = this._tileCoordsToNwSe(t), i = this._crs, n = H(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === ji ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = St.prototype.getTileUrl.call(this, t);
    ...
    var ht = J.extend({
      ...
      _destroyContainer: function() {
        V(this._redrawRequest), delete this._ctx, k(this._container), M(this._container), delete this._container;
      },
      _updatePaths: function() {
    ...
    var Gt = function() {
      ...
      _initPath: function(t) {
        ...
        g(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = Gt("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[x(t)] = t;
      },
      _addPath: function(t) {
        var e = t._container;
      ...
      _updateStyle: function(t) {
        ...
        o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (e || (e = t._stroke = Gt("stroke")), o.appendChild(e), e.weight = n.weight + "px", e.color = n.color, e.opacity = n.opacity, n.dashArray ? e.dashStyle = Y(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : e.dashStyle = "", e.endcap = n.lineCap.replace("butt", "flat"), e.joinstyle = n.lineJoin) : e && (o.removeChild(e), t._stroke = null), n.fill ? (i || (i = t._fill = Gt("fill")), o.appendChild(i), i.color = n.fillColor || n.color, i.opacity = n.fillOpacity) : i && (o.removeChild(i), t._fill = null);
      },
      _updateCircle: function(t) {
      ...
      _initPath: function(t) {
        ...
        t.options.className && g(e, t.options.className), t.options.interactive && g(e, "leaflet-interactive"), this._updateStyle(t), this._layers[x(t)] = t;
      },
      _addPath: function(t) {
    ...
    f.vml && Vt.include(Io);
    function sn(t) {
      return f.svg || f.vml ? new Vt(t) : null;
    }
    w.include({
    ...
    var rn = Mt.extend({
      initialize: function(t, e) {
        Mt.prototype.initialize.call(this, this._boundsToLatLngs(t), e);
      },
    ...
    Vt.create = le, Vt.pointsToPath = hi, at.geometryToLayer = ne, at.coordsToLatLng = qe, at.coordsToLatLngs = oe, at.latLngToCoords = je, at.latLngsToCoords = se, at.getFeature = Ct, at.asFeature = re, w.mergeOptions({
    ...
    var an = et.extend({
      ...
      _onMouseDown: function(t) {
        if (!t.shiftKey || t.which !== 1 && t.button !== 1)
          return !1;
        this._clearDeferredResetState(), this._resetState(), Bt(), ze(), this._startPoint = this._map.mouseEventToContainerPoint(t), p(document, {
          contextmenu: vt,
      ...
      _finish: function() {
        this._moved && (k(this._box), Z(this._container, "leaflet-crosshair")), Nt(), ke(), M(document, {
          contextmenu: vt,
          mousemove: this._onMouseMove,
          mouseup: this._onMouseUp,
          keydown: this._onKeyDown
    ...
    w.addInitHook("addHandler", "boxZoom", an), w.mergeOptions({
    ...
    w.addInitHook("addHandler", "doubleClickZoom", hn), w.mergeOptions({
    ...
    var un = et.extend({
      ...
      _onDragEnd: function(t) {
        ...
        if (e.fire("dragend", t), n)
          ...
          !v.x && !v.y ? e.fire("moveend") : (v = e._limitOffset(v, e.options.maxBounds), F(function() {
            e.panBy(v, {
              duration: d,
              easeLinearity: r,
              noMoveStart: !0,
    ...
    w.addInitHook("addHandler", "dragging", un), w.mergeOptions({
      // @option keyboard: Boolean = true
    ...
    w.addInitHook("addHandler", "keyboard", ln), w.mergeOptions({
    ...
    w.addInitHook("addHandler", "scrollWheelZoom", cn);
    var Bo = 600;
    w.mergeOptions({
      ...
      _onDown: function(t) {
        if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
          ...
          this._startPos = this._newPos = new m(e.clientX, e.clientY), this._holdTimeout = setTimeout(C(function() {
            this._cancel(), this._isTapValid() && (p(document, "touchend", R), p(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
    ...
    w.addInitHook("addHandler", "tapHold", fn), w.mergeOptions({
      // @section Touch interaction options
    ...
    var dn = et.extend({
      ...
      _onTouchMove: function(t) {
        if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
          ...
          this._animRequest = F(r, this, !0), R(t);
        }
      },
    ...
    w.addInitHook("addHandler", "touchZoom", dn), w.BoxZoom = an, w.DoubleClickZoom = hn, w.Drag = un, w.Keyboard = ln, w.ScrollWheelZoom = cn, w.TapHold = fn, w.TouchZoom = dn, l.Bounds = z, l.Browser = f, l.CRS = ot, l.Canvas = nn, l.Circle = Ve, l.CircleMarker = ie, l.Class = nt, l.Control = X, l.DivIcon = Qi, l.DivOverlay = it, l.DomEvent = Qn, l.DomUtil = Jn, l.Draggable = ft, l.Evented = Et, l.FeatureGroup = st, l.GeoJSON = at, l.GridLayer = Ut, l.Handler = et, l.Icon = bt, l.ImageOverlay = ae, l.LatLng = b, l.LatLngBounds = W, l.Layer = J, l.LayerGroup = Tt, l.LineUtil = fo, l.Map = w, l.Marker = ee, l.Mixin = ro, l.Path = dt, l.Point = m, l.PolyUtil = ao, l.Polygon = Mt, l.Polyline = rt, l.Popup = he, l.PosAnimation = Ai, l.Projection = _o, l.Rectangle = rn, l.Renderer = ht, l.SVG = Vt, l.SVGOverlay = $i, l.TileLayer = St, l.Tooltip = ue, l.Transformation = ge, l.Util = yn, l.VideoOverlay = Ji, l.bind = C, l.bounds = H, l.canvas = on, l.circle = Po, l.circleMarker = xo, l.control = Ft, l.divIcon = Eo, l.extend = T, l.featureGroup = vo, l.geoJSON = Xi, l.geoJson = bo, l.gridLayer = Zo, l.icon = yo, l.imageOverlay = Mo, l.latLng = y, l.latLngBounds = O, l.layerGroup = go, l.map = to, l.marker = wo, l.point = _, l.polygon = To, l.polyline = Lo, l.popup = zo, l.rectangle = Ao, l.setOptions = S, l.stamp = x, l.svg = sn, l.svgOverlay = So, l.tileLayer = tn, l.tooltip = ko, l.transformation = Zt, l.version = lt, l.videoOverlay = Co;
    var No = window.L;
...
var Ko = Je.exports;
const Xe = /* @__PURE__ */ jo(Ko);
class gn {
  constructor(B) {
    this.map = null, this.marker = null, this.container = document.createElement("div"), this.container.id = B, this.container.style.height = "400px", this.container.style.width = "100%";
  }
  initialize(B = 51.505, l = -0.09) {
    return this.map = Xe.map(this.container).setView([B, l], 13), Xe.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
      attribution: "© OpenStreetMap contributors"
    }).addTo(this.map), this.map.on("click", (lt) => {
      const { lat: T, lng: wt } = lt.latlng;
      this.setMarker(T, wt);
    }), this.container;
  }
  setMarker(B, l) {
    return this.map ? (this.marker && this.marker.remove(), this.marker = Xe.marker([B, l]).addTo(this.map), { lat: B, lng: l }) : null;
  }
  getCoordinates() {
    if (this.marker) {
      const B = this.marker.getLatLng();
      return {
        lat: B.lat,
        lng: B.lng
      };
...
class Yo {
  constructor() {
    this.id = "glide-map-plugin", this.name = "Glide Map Plugin", this.description = "A map plugin for Glide Apps with pin dropping functionality", this.version = "1.0.0", this.mapComponent = null;
  }
  initialize() {
    console.log("Map Plugin initialized"), this.mapComponent = new gn("map-container");
  }
  createMap(B = "map-container") {
    return this.mapComponent || (this.mapComponent = new gn(B)), {
      type: "create-map",
      compute: () => {
        var l;
        return (l = this.mapComponent) == null ? void 0 : l.initialize();
      }
    };
  }
  dropPin(B, l) {
    return {
      ...
      compute: () => {
        var lt;
        return (lt = this.mapComponent) == null ? void 0 : lt.setMarker(B, l);
      }
    };
  }
  getLocation() {
    return {
      ...
      compute: () => {
        var B;
        return (B = this.mapComponent) == null ? void 0 : B.getCoordinates();
      }
    };
  }
}
